 ...
 *
 */
public class SetAppsAuthoritiesRequest extends RpcAcsRequest<SetAppsAuthoritiesResponse> {
	...
	@Override
	public Class<SetAppsAuthoritiesResponse> getResponseClass() {
		return SetAppsAuthoritiesResponse.class;
	}
