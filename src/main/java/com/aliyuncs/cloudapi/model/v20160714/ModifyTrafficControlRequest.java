 ...
 *
 */
public class ModifyTrafficControlRequest extends RpcAcsRequest<ModifyTrafficControlResponse> {
	...
	@Override
	public Class<ModifyTrafficControlResponse> getResponseClass() {
		return ModifyTrafficControlResponse.class;
	}
