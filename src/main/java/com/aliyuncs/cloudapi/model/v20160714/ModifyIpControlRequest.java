 ...
 *
 */
public class ModifyIpControlRequest extends RpcAcsRequest<ModifyIpControlResponse> {
	
	public ModifyIpControlRequest() {
		super("CloudAPI", "2016-07-14", "ModifyIpControl", "apigateway");
	}
	...
	@Override
	public Class<ModifyIpControlResponse> getResponseClass() {
		return ModifyIpControlResponse.class;
	}
